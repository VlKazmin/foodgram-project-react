    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(db_index=True, error_messages={'unique': 'Пользователь с таким именем уже существует.'}, max_length=150, unique=True, validators=[users.validators.validate_not_me, users.validators.Username_Validator], verbose_name='Имя пользователя')),
